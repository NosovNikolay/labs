 ...
 * @param int a - число 1
 * @param int b - число 2
 * @return int nod - НОД 1 та 2 числа
 */
 ...
 * @param int a12 - числоч
 * @return result - 1 або 0
 */
 ...
 * @param float chislo1 - число
 * @return sqrt - Квадратний корінь заданого числа
 */
 ...
 * @param int var - кількість елементів
 * @param ... - Числова послідовність
 * @return count - Кількість пар
 */
int couples(int var, ...) {
    int count = 0;
    va_list vl;
 ...
 * @param char mass[] - Массив із словом або словосполученням
 */
 ...
 * @param відсутні
 * @return успішний код повернення (0)
 *
 */
int main() {
